...
router.post('/seller', async (req, res) => {
  try {
    ...
    //('  name:', serializedSeller.name);
    //('  email:', serializedSeller.email);
    //('  shopName:', serializedSeller.shopName);
    //('  phoneNumber:', serializedSeller.phoneNumber);
    //('  city:', serializedSeller.city);
    //('  pincode:', serializedSeller.pincode);
    //('  businessCategory:', serializedSeller.businessCategory);
    //('  lowStockThreshold:', serializedSeller.lowStockThreshold);
    //('  expiryDaysThreshold:', serializedSeller.expiryDaysThreshold);
