    ...
    for (const item of items) {
      try {
        ...
        for (const orderItem of item.items) {
          ...
          let productLocalId = orderItem.productLocalId || orderItem.productId;
          let productMongoId = orderItem.productMongoId;
          let resolvedProductId = null;

          if (mongoose.isValidObjectId(orderItem.productId)) {
            productMongoId = orderItem.productId;
          }
          ...
          processedItems.push({
            ...orderItem,
            productId: resolvedProductId, // Legacy ObjectId
            productLocalId: productLocalId, // Stable Local ID
            productMongoId: productMongoId, // Stable Mongo ID
            // Ensure numbers
