...
const createProductBatch = async (req, res) => {
  try {
    ...
    if (!productId || !mfg || !expiry || !quantity || !costPrice || !sellingUnitPrice) {
      return res.status(400).json({
        success: false,
        message: 'Missing required fields: productId, mfg, expiry, quantity, costPrice, sellingUnitPrice'
      });
    }
        ...
        case 'products':
          ...
          fetchPromises.push((async () => {
            try {
              ...
              console.log(`🔄 GET ALL DATA: All batches with seller IDs:`, allBatchesWithSeller.map(b => ({
            ...
            batches.forEach(batch => {
              ...
              console.log(`🔄 GET ALL DATA: Product batch data summary:`, Object.keys(productBatchData).map(productId => ({
                productId,
