...
const getAllData = async (req, res) => {
  try {
    ...
    const dataTypesToCheck = ['customers', 'products', 'productBatches', 'orders', 'transactions', 'purchaseOrders', 'categories', 'refunds', 'plans', 'planOrders', 'expenses', 'customerTransactions'];
