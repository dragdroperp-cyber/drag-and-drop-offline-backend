...
const getAllData = async (req, res) => {
  try {
    ...
    const dataTypesToCheck = ['customers', 'products', 'productBatches', 'orders', 'transactions', 'purchaseOrders', 'categories', 'refunds', 'plans', 'planOrders', 'expenses', 'customerTransactions', 'suppliers', 'supplierTransactions', 'dProducts'];
    ...
    changedDataTypes.forEach(dataType => {
      switch (dataType) {
        ...
        case 'dProducts':
          ...
          fetchPromises.push(DProductModel.find({ sellerId }).sort({ createdAt: -1 }));
