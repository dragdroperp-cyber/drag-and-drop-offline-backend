        ...
        type: {
            ...
            validate: {
                validator: function (value) {
                    ...
                    return ["cash_online", "online_due", "cash_due", "cash_online_due"].includes(value);
                },
                message: 'Type must be one of: cash_online, online_due, cash_due, cash_online_due'
            }
        },
        cashAmount: {
            type: Number,
...
OrderSchema.pre('save', function (next) {
    ...
    // If splitPaymentDetails exists but type is null or undefined, try to infer it instead of removing
        ...
        if (cash > 0 && online > 0 && due > 0) this.splitPaymentDetails.type = 'cash_online_due';
