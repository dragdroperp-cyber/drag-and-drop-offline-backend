...
syncTrackingSchema.statics.ensureTracking = async function (sellerId) {
  try {
    ...
    const dataTypes = ['customers', 'products', 'productBatches', 'categories', 'orders', 'planOrders', 'refunds', 'transactions', 'customerTransactions', 'vendorOrders', 'expenses', 'achievements', 'staff', 'suppliers', 'supplierTransactions', 'dProducts'];
